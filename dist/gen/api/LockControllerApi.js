...
var _ResponseWrapperPageResponseTaNftLockerLockInfo = require("../model/ResponseWrapperPageResponseTaNftLockerLockInfo");
var _ResponseWrapperPageResponseV4NftLockerLockInfos = require("../model/ResponseWrapperPageResponseV4NftLockerLockInfos");
var _ResponseWrapperTokenLockerResponse = require("../model/ResponseWrapperTokenLockerResponse");
var _ResponseWrapperV4LpLockerLockInfoResp = require("../model/ResponseWrapperV4LpLockerLockInfoResp");
/*
...
class LockControllerApi {
  ...
  */
  ...
  getNftLockerLockInfosListUsingGET(pageNum, pageSize, callback) {
    ...
    let contentTypes = [];
    let accepts = ['*/*'];
    let returnType = _ResponseWrapperPageResponseTaNftLockerLockInfo.ResponseWrapperPageResponseTaNftLockerLockInfo;
    return this.apiClient.callApi('/open/api/v1/locks/lpv3s', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  /**
  ...
  getV4NftLockerLockInfosListUsingGET(pageNum, pageSize, callback) {
    ...
    let contentTypes = [];
    let accepts = ['*/*'];
    let returnType = _ResponseWrapperPageResponseV4NftLockerLockInfos.ResponseWrapperPageResponseV4NftLockerLockInfos;
    return this.apiClient.callApi('/open/api/v1/locks/lpv4s', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  /**
  ...
  getV4NftLockersUsingGET(chainId, pageNum, pageSize, poolId, callback) {
    ...
    let contentTypes = [];
    let accepts = ['*/*'];
    let returnType = _ResponseWrapperV4LpLockerLockInfoResp.ResponseWrapperV4LpLockerLockInfoResp;
    return this.apiClient.callApi('/open/api/v1/locks/lpv4', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
}
