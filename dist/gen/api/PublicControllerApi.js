...
exports.PublicControllerApi = void 0;
var _ApiClient = require("../ApiClient");
var _DustAttackDetectionReq = require("../model/DustAttackDetectionReq");
var _ResponseWrapperDustAttackDetection = require("../model/ResponseWrapperDustAttackDetection");
/*
...
class PublicControllerApi {
  ...
  */
  ...
  dustAttackDetectionUsingPOST(body, opts, callback) {
    ...
    let accepts = ['*/*'];
    let returnType = _ResponseWrapperDustAttackDetection.ResponseWrapperDustAttackDetection;
    return this.apiClient.callApi('/api/v1/dust_attack_detection', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
}
exports.PublicControllerApi = PublicControllerApi;