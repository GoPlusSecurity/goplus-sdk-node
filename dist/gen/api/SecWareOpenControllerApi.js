...
exports.SecWareOpenControllerApi = void 0;
var _ApiClient = require("../ApiClient");
var _ResponseWrapperGetScanResult = require("../model/ResponseWrapperGetScanResult");
var _ResponseWrapperOpenScanAddressResp = require("../model/ResponseWrapperOpenScanAddressResp");
/*
...
* @version 1.0
*/
class SecWareOpenControllerApi {
  /**
  ...
  */
  ...
  getScanResultUsingGET(request_id, opts, callback) {
    ...
    let contentTypes = [];
    let accepts = ['*/*'];
    let returnType = _ResponseWrapperGetScanResult.ResponseWrapperGetScanResult;
    return this.apiClient.callApi('/api/v1/address/result', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  /**
  ...
  scanAddressUsingGET(address, chain_id, opts, callback) {
    ...
    let contentTypes = [];
    let accepts = ['*/*'];
    let returnType = _ResponseWrapperOpenScanAddressResp.ResponseWrapperOpenScanAddressResp;
    return this.apiClient.callApi('/api/v1/address/scan/{chain_id}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
}
exports.SecWareOpenControllerApi = SecWareOpenControllerApi;