...
class TokenControllerV1Api {
  ...
  */
  ...
  getChainsListUsingGET(opts, callback) {
    ...
    let contentTypes = [];
    let accepts = ['*/*'];
    let returnType = _ResponseWrapperListJSONObject9524a1c652c545bfB6c6898bfc3e93f.ResponseWrapperListJSONObject9524a1c652c545bfB6c6898bfc3e93f3;
  ...
  tokenSecurityUsingGET1(chainId, contractAddresses, opts, callback) {
    ...
    let contentTypes = [];
    let accepts = ['*/*'];
    let returnType = _ResponseWrapperTaTokenSecurityResponse205696bcFb354bc5Ab26Ddc7cd495fe.ResponseWrapperTaTokenSecurityResponse205696bcFb354bc5Ab26Ddc7cd495fe2;
