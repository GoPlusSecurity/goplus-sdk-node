...
exports.TransactionSecurityControllerApi = void 0;
var _ApiClient = require("../ApiClient");
var _ResponseWrapperTransactionSecurityResponse = require("../model/ResponseWrapperTransactionSecurityResponse");
var _TransactionSecurityRequest = require("../model/TransactionSecurityRequest");
/*
...
class TransactionSecurityControllerApi {
  ...
  */
  ...
  getTransactionSecurityInfoUsingPOST(body, opts, callback) {
    ...
    let accepts = ['*/*'];
    let returnType = _ResponseWrapperTransactionSecurityResponse.ResponseWrapperTransactionSecurityResponse;
    return this.apiClient.callApi('/api/v1/transaction_simulation', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
}
exports.TransactionSecurityControllerApi = TransactionSecurityControllerApi;