...
exports.TransactionSimulationForSolanaApi = void 0;
...
class TransactionSimulationForSolanaApi {
  ...
  */
  ...
  prerunTxUsingPOST(body, opts, callback) {
    ...
    let accepts = ['*/*'];
    let returnType = _ResponseWrapperSolanaPrerunTxResponse.ResponseWrapperSolanaPrerunTxResponse;
    return this.apiClient.callApi('/pis/api/v1/solana/pre_execution', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
}
exports.TransactionSimulationForSolanaApi = TransactionSimulationForSolanaApi;