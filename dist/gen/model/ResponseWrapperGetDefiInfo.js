...
exports.ResponseWrapperGetDefiInfo = void 0;
var _ApiClient = require("../ApiClient");
var _ResponseWrapperGetDefiInfoResult = require("./ResponseWrapperGetDefiInfoResult");
/*
 ...
 * @version 1.0
 */
class ResponseWrapperGetDefiInfo {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('result')) obj.result = _ResponseWrapperGetDefiInfoResult.ResponseWrapperGetDefiInfoResult.constructFromObject(data['result']);
    }
    return obj;
  }
}
 ...
 * @member {Number} code
 */
exports.ResponseWrapperGetDefiInfo = ResponseWrapperGetDefiInfo;
