...
exports.ResponseWrapperGetDefiInfoResult = void 0;
var _ApiClient = require("../ApiClient");
var _ResponseWrapperGetDefiInfoResultOwner = require("./ResponseWrapperGetDefiInfoResultOwner");
/*
 ...
 * @version 1.0
 */
class ResponseWrapperGetDefiInfoResult {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('owner')) obj.owner = _ResponseWrapperGetDefiInfoResultOwner.ResponseWrapperGetDefiInfoResultOwner.constructFromObject(data['owner']);
 ...
 */
exports.ResponseWrapperGetDefiInfoResult = ResponseWrapperGetDefiInfoResult;
