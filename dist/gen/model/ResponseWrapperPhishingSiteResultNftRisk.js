...
exports.ResponseWrapperPhishingSiteResultNftRisk = void 0;
var _ApiClient = require("../ApiClient");
var _ResponseWrapperPhishingSiteResultNftRiskPrivilegedBurn = require("./ResponseWrapperPhishingSiteResultNftRiskPrivilegedBurn");
var _ResponseWrapperPhishingSiteResultNftRiskPrivilegedMinting = require("./ResponseWrapperPhishingSiteResultNftRiskPrivilegedMinting");
var _ResponseWrapperPhishingSiteResultNftRiskSelfDestruct = require("./ResponseWrapperPhishingSiteResultNftRiskSelfDestruct");
var _ResponseWrapperPhishingSiteResultNftRiskTransferWithoutApproval = require("./ResponseWrapperPhishingSiteResultNftRiskTransferWithoutApproval");
/*
...
class ResponseWrapperPhishingSiteResultNftRisk {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('privileged_minting')) obj.privileged_minting = _ResponseWrapperPhishingSiteResultNftRiskPrivilegedMinting.ResponseWrapperPhishingSiteResultNftRiskPrivilegedMinting.constructFromObject(data['privileged_minting']);
      ...
      if (data.hasOwnProperty('transfer_without_approval')) obj.transfer_without_approval = _ResponseWrapperPhishingSiteResultNftRiskTransferWithoutApproval.ResponseWrapperPhishingSiteResultNftRiskTransferWithoutApproval.constructFromObject(data['transfer_without_approval']);
      if (data.hasOwnProperty('privileged_burn')) obj.privileged_burn = _ResponseWrapperPhishingSiteResultNftRiskPrivilegedBurn.ResponseWrapperPhishingSiteResultNftRiskPrivilegedBurn.constructFromObject(data['privileged_burn']);
      if (data.hasOwnProperty('self_destruct')) obj.self_destruct = _ResponseWrapperPhishingSiteResultNftRiskSelfDestruct.ResponseWrapperPhishingSiteResultNftRiskSelfDestruct.constructFromObject(data['self_destruct']);
    }
    return obj;
  }
}
 ...
 */
exports.ResponseWrapperPhishingSiteResultNftRisk = ResponseWrapperPhishingSiteResultNftRisk;
