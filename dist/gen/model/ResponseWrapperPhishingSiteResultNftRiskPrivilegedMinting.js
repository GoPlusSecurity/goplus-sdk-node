...
exports.ResponseWrapperPhishingSiteResultNftRiskPrivilegedMinting = void 0;
...
/**
 * The ResponseWrapperPhishingSiteResultNftRiskPrivilegedMinting model module.
 * @module model/ResponseWrapperPhishingSiteResultNftRiskPrivilegedMinting
 * @version 1.0
 */
class ResponseWrapperPhishingSiteResultNftRiskPrivilegedMinting {
  /**
   * Constructs a new <code>ResponseWrapperPhishingSiteResultNftRiskPrivilegedMinting</code>.
   ...
   * @alias module:model/ResponseWrapperPhishingSiteResultNftRiskPrivilegedMinting
   * @class
   */
  constructor() {}

  /**
   * Constructs a <code>ResponseWrapperPhishingSiteResultNftRiskPrivilegedMinting</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ResponseWrapperPhishingSiteResultNftRiskPrivilegedMinting} obj Optional instance to populate.
   * @return {module:model/ResponseWrapperPhishingSiteResultNftRiskPrivilegedMinting} The populated <code>ResponseWrapperPhishingSiteResultNftRiskPrivilegedMinting</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new ResponseWrapperPhishingSiteResultNftRiskPrivilegedMinting();
 ...
 */
exports.ResponseWrapperPhishingSiteResultNftRiskPrivilegedMinting = ResponseWrapperPhishingSiteResultNftRiskPrivilegedMinting;
ResponseWrapperPhishingSiteResultNftRiskPrivilegedMinting.prototype.owner_address = undefined;
 ...
 * @member {Number} value
 */
ResponseWrapperPhishingSiteResultNftRiskPrivilegedMinting.prototype.value = undefined;
 ...
 */
ResponseWrapperPhishingSiteResultNftRiskPrivilegedMinting.prototype.owner_type = undefined;