...
exports.ResponseWrapperPhishingSiteResultNftRiskTransferWithoutApproval = void 0;
...
/**
 * The ResponseWrapperPhishingSiteResultNftRiskTransferWithoutApproval model module.
 * @module model/ResponseWrapperPhishingSiteResultNftRiskTransferWithoutApproval
 * @version 1.0
 */
class ResponseWrapperPhishingSiteResultNftRiskTransferWithoutApproval {
  /**
   * Constructs a new <code>ResponseWrapperPhishingSiteResultNftRiskTransferWithoutApproval</code>.
   ...
   * @alias module:model/ResponseWrapperPhishingSiteResultNftRiskTransferWithoutApproval
   * @class
   */
  constructor() {}

  /**
   * Constructs a <code>ResponseWrapperPhishingSiteResultNftRiskTransferWithoutApproval</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ResponseWrapperPhishingSiteResultNftRiskTransferWithoutApproval} obj Optional instance to populate.
   * @return {module:model/ResponseWrapperPhishingSiteResultNftRiskTransferWithoutApproval} The populated <code>ResponseWrapperPhishingSiteResultNftRiskTransferWithoutApproval</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new ResponseWrapperPhishingSiteResultNftRiskTransferWithoutApproval();
 ...
 */
exports.ResponseWrapperPhishingSiteResultNftRiskTransferWithoutApproval = ResponseWrapperPhishingSiteResultNftRiskTransferWithoutApproval;
ResponseWrapperPhishingSiteResultNftRiskTransferWithoutApproval.prototype.owner_address = undefined;
 ...
 * @member {Number} value
 */
ResponseWrapperPhishingSiteResultNftRiskTransferWithoutApproval.prototype.value = undefined;
 ...
 */
ResponseWrapperPhishingSiteResultNftRiskTransferWithoutApproval.prototype.owner_type = undefined;