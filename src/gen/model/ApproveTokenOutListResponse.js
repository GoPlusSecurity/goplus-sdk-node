...
import {ApproveTokenResult} from './ApproveTokenResult';
 ...
 * @version 1.0
 */
export class ApproveTokenOutListResponse {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('approved_list'))
        obj.approvedList = ApiClient.convertToType(data['approved_list'], [ApproveTokenResult]);
      ...
      if (data.hasOwnProperty('token_address'))
        obj.tokenAddress = ApiClient.convertToType(data['token_address'], 'String');
