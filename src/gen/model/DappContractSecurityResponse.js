...
import {ContractsSecurity} from './ContractsSecurity';
 ...
 * @version 1.0
 */
export class DappContractSecurityResponse {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('audit_info'))
        obj.auditInfo = ApiClient.convertToType(data['audit_info'], [AuditInfo]);
      if (data.hasOwnProperty('contracts_security'))
        obj.contractsSecurity = ApiClient.convertToType(data['contracts_security'], [ContractsSecurity]);
      if (data.hasOwnProperty('is_audit'))
        obj.isAudit = ApiClient.convertToType(data['is_audit'], 'Number');
