  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('audit_info'))
        obj.audit_info = ApiClient.convertToType(data['audit_info'], [AuditInfo]);
      if (data.hasOwnProperty('contracts_security'))
        obj.contracts_security = ApiClient.convertToType(data['contracts_security'], [ContractsSecurity]);
      if (data.hasOwnProperty('is_audit'))
        obj.is_audit = ApiClient.convertToType(data['is_audit'], 'Number');
