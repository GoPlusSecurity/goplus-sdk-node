...
import {GetDefiInfoResponseResult} from './GetDefiInfoResponseResult';
 ...
 * @version 1.0
 */
export class GetDefiInfoResponse {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('result'))
        obj.result = GetDefiInfoResponseResult.constructFromObject(data['result']);
    }
    return obj;
  }
}
