...
import {GetDefiInfoResponseResultOwner} from './GetDefiInfoResponseResultOwner';
 ...
 * @version 1.0
 */
export class GetDefiInfoResponseResult {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('owner'))
        obj.owner = GetDefiInfoResponseResultOwner.constructFromObject(data['owner']);
