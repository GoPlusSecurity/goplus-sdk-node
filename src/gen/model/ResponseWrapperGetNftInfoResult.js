...
import {ResponseWrapperGetNftInfoResultPrivilegedBurn} from './ResponseWrapperGetNftInfoResultPrivilegedBurn';
import {ResponseWrapperGetNftInfoResultPrivilegedMinting} from './ResponseWrapperGetNftInfoResultPrivilegedMinting';
import {ResponseWrapperGetNftInfoResultSameNfts} from './ResponseWrapperGetNftInfoResultSameNfts';
import {ResponseWrapperGetNftInfoResultSelfDestruct} from './ResponseWrapperGetNftInfoResultSelfDestruct';
import {ResponseWrapperGetNftInfoResultTransferWithoutApproval} from './ResponseWrapperGetNftInfoResultTransferWithoutApproval';
 ...
 * @version 1.0
 */
export class ResponseWrapperGetNftInfoResult {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('traded_volume_24h'))
        obj.traded_volume_24h = ApiClient.convertToType(data['traded_volume_24h'], 'Number');
      ...
      if (data.hasOwnProperty('red_check_mark'))
        obj.red_check_mark = ApiClient.convertToType(data['red_check_mark'], 'Number');
      ...
      if (data.hasOwnProperty('highest_price'))
        obj.highest_price = ApiClient.convertToType(data['highest_price'], 'Number');
      if (data.hasOwnProperty('transfer_without_approval'))
        obj.transfer_without_approval = ResponseWrapperGetNftInfoResultTransferWithoutApproval.constructFromObject(data['transfer_without_approval']);
      ...
      if (data.hasOwnProperty('privileged_minting'))
        obj.privileged_minting = ResponseWrapperGetNftInfoResultPrivilegedMinting.constructFromObject(data['privileged_minting']);
      if (data.hasOwnProperty('nft_owner_number'))
        obj.nft_owner_number = ApiClient.convertToType(data['nft_owner_number'], 'Number');
      ...
      if (data.hasOwnProperty('lowest_price_24h'))
        obj.lowest_price_24h = ApiClient.convertToType(data['lowest_price_24h'], 'Number');
      if (data.hasOwnProperty('average_price_24h'))
        obj.average_price_24h = ApiClient.convertToType(data['average_price_24h'], 'Number');
      if (data.hasOwnProperty('nft_erc'))
        obj.nft_erc = ApiClient.convertToType(data['nft_erc'], 'String');
      ...
      if (data.hasOwnProperty('medium_url'))
        obj.medium_url = ApiClient.convertToType(data['medium_url'], 'String');
      if (data.hasOwnProperty('malicious_nft_contract'))
        obj.malicious_nft_contract = ApiClient.convertToType(data['malicious_nft_contract'], 'Number');
      if (data.hasOwnProperty('privileged_burn'))
        obj.privileged_burn = ResponseWrapperGetNftInfoResultPrivilegedBurn.constructFromObject(data['privileged_burn']);
      ...
      if (data.hasOwnProperty('same_nfts'))
        obj.same_nfts = ApiClient.convertToType(data['same_nfts'], [ResponseWrapperGetNftInfoResultSameNfts]);
      if (data.hasOwnProperty('nft_items'))
        obj.nft_items = ApiClient.convertToType(data['nft_items'], 'Number');
      ...
      if (data.hasOwnProperty('sales_24h'))
        obj.sales_24h = ApiClient.convertToType(data['sales_24h'], 'Number');
      if (data.hasOwnProperty('create_block_number'))
        obj.create_block_number = ApiClient.convertToType(data['create_block_number'], 'Number');
    }
    return obj;
  }
}
