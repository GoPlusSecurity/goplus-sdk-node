 ...
 * @version 1.0
 */
export class ResponseWrapperSolanaTokenSecurityMetadataMutable {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('metadata_upgrade_authority'))
        obj.metadata_upgrade_authority = ApiClient.convertToType(data['metadata_upgrade_authority'], [ResponseWrapperSolanaTokenSecurityClosableAuthority]);
