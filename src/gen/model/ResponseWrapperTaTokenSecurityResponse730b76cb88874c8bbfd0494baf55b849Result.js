...
import {ResponseWrapperTaTokenSecurityResponse730b76cb88874c8bbfd0494baf55b849Dex} from './ResponseWrapperTaTokenSecurityResponse730b76cb88874c8bbfd0494baf55b849Dex';
import {ResponseWrapperTaTokenSecurityResponse730b76cb88874c8bbfd0494baf55b849LpHolders} from './ResponseWrapperTaTokenSecurityResponse730b76cb88874c8bbfd0494baf55b849LpHolders';
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('lp_holders'))
        obj.lpHolders = ApiClient.convertToType(data['lp_holders'], [ResponseWrapperTaTokenSecurityResponse730b76cb88874c8bbfd0494baf55b849LpHolders]);
      ...
      if (data.hasOwnProperty('holders'))
        obj.holders = ApiClient.convertToType(data['holders'], [ResponseWrapperTaTokenSecurityResponse730b76cb88874c8bbfd0494baf55b849LpHolders]);
      if (data.hasOwnProperty('dex'))
        obj.dex = ApiClient.convertToType(data['dex'], [ResponseWrapperTaTokenSecurityResponse730b76cb88874c8bbfd0494baf55b849Dex]);
