 ...
 * @version 1.0
 */
export class ResponseWrapperTokenSecurityNFTList {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('NFT_percentage'))
        obj.NFT_percentage = ApiClient.convertToType(data['NFT_percentage'], 'String');
      if (data.hasOwnProperty('NFT_id'))
        obj.NFT_id = ApiClient.convertToType(data['NFT_id'], 'String');
      if (data.hasOwnProperty('amount'))
        obj.amount = ApiClient.convertToType(data['amount'], 'String');
      if (data.hasOwnProperty('in_effect'))
        obj.in_effect = ApiClient.convertToType(data['in_effect'], 'String');
