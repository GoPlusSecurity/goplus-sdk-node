 ...
 * @version 1.0
 */
export class ResponseWrapperTokenSecurityResult {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('lp_total_supply'))
        obj.lp_total_supply = ApiClient.convertToType(data['lp_total_supply'], 'String');
      if (data.hasOwnProperty('lp_holders'))
        obj.lp_holders = ApiClient.convertToType(data['lp_holders'], [ResponseWrapperTokenSecurityLpHolders]);
      if (data.hasOwnProperty('is_airdrop_scam'))
        obj.is_airdrop_scam = ApiClient.convertToType(data['is_airdrop_scam'], 'String');
      if (data.hasOwnProperty('other_potential_risks'))
        obj.other_potential_risks = ApiClient.convertToType(data['other_potential_risks'], 'String');
      if (data.hasOwnProperty('transfer_pausable'))
        obj.transfer_pausable = ApiClient.convertToType(data['transfer_pausable'], 'String');
      if (data.hasOwnProperty('trading_cooldown'))
        obj.trading_cooldown = ApiClient.convertToType(data['trading_cooldown'], 'String');
      if (data.hasOwnProperty('hidden_owner'))
        obj.hidden_owner = ApiClient.convertToType(data['hidden_owner'], 'String');
      ...
      if (data.hasOwnProperty('owner_percent'))
        obj.owner_percent = ApiClient.convertToType(data['owner_percent'], 'String');
      if (data.hasOwnProperty('is_whitelisted'))
        obj.is_whitelisted = ApiClient.convertToType(data['is_whitelisted'], 'String');
      if (data.hasOwnProperty('holder_count'))
        obj.holder_count = ApiClient.convertToType(data['holder_count'], 'String');
      ...
      if (data.hasOwnProperty('is_open_source'))
        obj.is_open_source = ApiClient.convertToType(data['is_open_source'], 'String');
      ...
      if (data.hasOwnProperty('creator_percent'))
        obj.creator_percent = ApiClient.convertToType(data['creator_percent'], 'String');
      if (data.hasOwnProperty('is_proxy'))
        obj.is_proxy = ApiClient.convertToType(data['is_proxy'], 'String');
      if (data.hasOwnProperty('creator_balance'))
        obj.creator_balance = ApiClient.convertToType(data['creator_balance'], 'String');
      if (data.hasOwnProperty('is_in_dex'))
        obj.is_in_dex = ApiClient.convertToType(data['is_in_dex'], 'String');
      if (data.hasOwnProperty('owner_balance'))
        obj.owner_balance = ApiClient.convertToType(data['owner_balance'], 'String');
      ...
      if (data.hasOwnProperty('is_true_token'))
        obj.is_true_token = ApiClient.convertToType(data['is_true_token'], 'String');
      if (data.hasOwnProperty('can_take_back_ownership'))
        obj.can_take_back_ownership = ApiClient.convertToType(data['can_take_back_ownership'], 'String');
      if (data.hasOwnProperty('is_blacklisted'))
        obj.is_blacklisted = ApiClient.convertToType(data['is_blacklisted'], 'String');
      ...
      if (data.hasOwnProperty('slippage_modifiable'))
        obj.slippage_modifiable = ApiClient.convertToType(data['slippage_modifiable'], 'String');
      if (data.hasOwnProperty('buy_tax'))
        obj.buy_tax = ApiClient.convertToType(data['buy_tax'], 'String');
      if (data.hasOwnProperty('external_call'))
        obj.external_call = ApiClient.convertToType(data['external_call'], 'String');
      if (data.hasOwnProperty('cannot_sell_all'))
        obj.cannot_sell_all = ApiClient.convertToType(data['cannot_sell_all'], 'String');
      if (data.hasOwnProperty('lp_holder_count'))
        obj.lp_holder_count = ApiClient.convertToType(data['lp_holder_count'], 'String');
      if (data.hasOwnProperty('personal_slippage_modifiable'))
        obj.personal_slippage_modifiable = ApiClient.convertToType(data['personal_slippage_modifiable'], 'String');
      if (data.hasOwnProperty('is_anti_whale'))
        obj.is_anti_whale = ApiClient.convertToType(data['is_anti_whale'], 'String');
      if (data.hasOwnProperty('is_mintable'))
        obj.is_mintable = ApiClient.convertToType(data['is_mintable'], 'String');
      if (data.hasOwnProperty('owner_change_balance'))
        obj.owner_change_balance = ApiClient.convertToType(data['owner_change_balance'], 'String');
      if (data.hasOwnProperty('cannot_buy'))
        obj.cannot_buy = ApiClient.convertToType(data['cannot_buy'], 'String');
      if (data.hasOwnProperty('anti_whale_modifiable'))
        obj.anti_whale_modifiable = ApiClient.convertToType(data['anti_whale_modifiable'], 'String');
